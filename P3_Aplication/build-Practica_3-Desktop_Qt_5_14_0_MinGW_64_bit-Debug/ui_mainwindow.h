...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        labelHz = new QLabel(tab);
        labelHz->setObjectName(QString::fromUtf8("labelHz"));
        labelHz->setGeometry(QRect(150, 20, 47, 21));
        QFont font;
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        labelHz->setText(QCoreApplication::translate("MainWindow", "Hz", nullptr));

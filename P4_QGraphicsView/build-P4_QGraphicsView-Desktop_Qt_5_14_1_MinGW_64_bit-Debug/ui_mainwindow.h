...
public:
    ...
    QSlider *horizontalSliderRotate;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        horizontalSliderRotate = new QSlider(centralwidget);
        horizontalSliderRotate->setObjectName(QString::fromUtf8("horizontalSliderRotate"));
        horizontalSliderRotate->setGeometry(QRect(110, 370, 201, 22));
        horizontalSliderRotate->setMaximum(359);
        horizontalSliderRotate->setOrientation(Qt::Horizontal);
        horizontalSliderScale = new QSlider(centralwidget);
        horizontalSliderScale->setObjectName(QString::fromUtf8("horizontalSliderScale"));
        horizontalSliderScale->setGeometry(QRect(110, 400, 201, 22));
        horizontalSliderScale->setMinimum(-99);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        labelRotate->setText(QCoreApplication::translate("MainWindow", "Rotate=0", nullptr));
        labelScale->setText(QCoreApplication::translate("MainWindow", "Scale=1", nullptr));
    } // retranslateUi
